    ...
    const work = [
        {
            ...
            description: 'Web Design of calculator',
            link: 'https://abhinav1346.github.io/calculator',
        },
        {
            name: 'Weather Forcasting',
            icon: './assets/work-2.png',
            description: 'Web application',
            link: 'https://abhinav1346.github.io/weather-app',
        },
        {
            name: 'Todu list site',
            icon: './assets/work-3.png',
            description: 'Web Design',
            link: 'https://abhinav1346.github.io/TODO-list',
        },
        {

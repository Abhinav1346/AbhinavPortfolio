    ...
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;m Abhinav Bhatnagar
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">frontend web developer based in India.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">I am a frontend developer from Jaipur, Rajasthan with 1 years of experience in RightShift solutions.</p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="/public/assets/technical RESUME.pdf" download
